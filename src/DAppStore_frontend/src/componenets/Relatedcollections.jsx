  ...
  return (
    <div>
      <div className="container flex flex-col justify-center items-center text-center pb-5 sm:pb-14">
        ...
        <div
          className="flex flex-col gap-4 w-full mb-4 mini:grid max-w-3xl mini:grid-cols-3 mini:gap-3 
         text-sm"
        >
          {btns.map((btn, index) => (
            <div
              key={index}
              className="flex text-[#333333] items-center justify-center gap-2 rounded-md border  px-4 py-2 cursor-pointer transition transform duration-300 hover:scale-110 shadow-lg "
            >
              <p>{btn.btn}</p>
              <FaArrowRightLong />
            </div>
      ...
      <div className="container deeporangebg flex flex-col text-center items-center pb-14 ">
        ...
        <div className="lorange bg-white rounded-md w-full py-2 font-semibold ">
          <img src="" alt="" />
          <p>Launch Now</p>
        </div>
      </div>
